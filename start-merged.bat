...
echo [3/8] Starting STEM-SCI research backend  http://127.0.0.1:8001
start "STEM-SCI-Research-API" /D "%ROOT%backend" cmd /k "set PYTHONPATH=%ROOT%backend\src&& python -m uvicorn stem_sci.main:app --host 127.0.0.1 --port 8001"

echo [4/8] Starting STEM-SCI research frontend http://127.0.0.1:5173
start "STEM-SCI-Research-Web" /D "%ROOT%frontend" cmd /k "npm.cmd run dev -- --host 127.0.0.1 --port 5173"
...
echo.
echo  Unified entry: http://127.0.0.1:5173
echo  Research API: http://127.0.0.1:8001
