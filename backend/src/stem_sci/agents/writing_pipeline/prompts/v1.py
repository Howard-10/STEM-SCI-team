...
SYSTEM_PROMPT = (
    ...
    "section purpose and common flow, including any empirical_framework in "
    "journal_constraints, but leave unsupported items explicitly absent. Treat writing "
    "frameworks as organization and quality guidance only, never as evidence. "
